...
Stage 8a-rev1: execute the molecular scalpel and build the revised capped
heavy-atom receptor scaffold from canonical 5LF7 coordinates.

Frozen revised first-reference peptide spans:
  Y:1-3
  Y:17-22
  Y:31-35    (adds catalytic Lys33 region)
  Y:45-50
  Y:129-131
  Y:167-170
  Z:124-126
...
SEGMENTS = [
    ("Y", 1, 3),
    ("Y", 17, 22),
    ("Y", 31, 35),   # catalytic Lys33 region; also retains Val31 pocket context
    ("Y", 45, 50),
    ("Y", 129, 131),
    ("Y", 167, 170),
    ("Z", 124, 126),
...
def main():
    ...
    manifest = {
        "stage": "8a_rev1_capped_heavy_atom_receptor_scaffold_with_Lys33",
        ...
        "manual_boundary_decision": {
            "Y31_35_added": True,
            "Y31_35_reason":
                "Adds the conserved catalytic Lys33 region; Val31 also contributes pocket context.",
            "Y45_included": True,
            "reason":
